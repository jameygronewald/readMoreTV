        ...
        $.ajax({
            ...
            $.ajax({
                ...
                while (i < 40) {
                    ...
                    let searchResultsRow = $('<div class="row searchRow"><div class="col-lg-2"><img id = "book' + i + 'Cover" src =' + bookCover + '></img><a href="' + bookPrice + '" class="buyBtn btn btn-link active" role="button" target="_blank" aria-pressed="true">Buy Here</a></div><div class="col-md-2 bookDescription"><p id = "book' + i + 'Title">' + "Title: "+ bookTitle + '</p><p id = "book' + i + 'Author">' + "Author: " + bookAuthor + '</p><p id = "book' + i + 'Year">' + "Release Date: " + bookYear + '</p></div><div id = "book' + i + 'Desc" class="col-sm-8">' + bookDesc + '</div></div><br>');
